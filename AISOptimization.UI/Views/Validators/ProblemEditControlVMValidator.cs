...
/// <summary>
/// Валидатор для <see cref="ProblemEditControlVM"/>
/// </summary>
public class ProblemEditControlVMValidator: AbstractValidator<ProblemEditControlVM>
{
    
    public ProblemEditControlVMValidator()
    {
